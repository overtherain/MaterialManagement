                            ...
                            <tr>
                                ...
                                <td width="100">
                                    <div class="control-group">
                                        <div class="row">
                                            <div class="col-xs-2">
                                                <a id="modifyItemBtn" name="modifyItemBtn" type="button" class="btn btn-primary" onclick="modifyItem('{{$activeeletype->ActiveID}}','{{$activeeletype->ActiveName}}','{{$activeeletype->ActiveValue}}')">修改</a>
                                            </div>
                                            <div class="col-xs-2">
                                                <form class="form col-md-12" role="form" method="POST" action="{{ route('EditActiveeleType.store') }}" >
                                                    {{ csrf_field() }}
                                                    <input id="deleteSubmit" name="deleteSubmit" type="text" class="form-control input-md hide" value="{{$activeeletype->ActiveID}}" readonly>
                                ...
                                <div class="modal-body">
                                    <form class="form col-md-12" role="form" method="POST" action="{{ route('EditActiveeleType.store') }}" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-8">
                                                <input id="modifyItemValue" name="modifyItemValue" type="text" class="form-control" value="" maxlength="1">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row ">
