                                ...
                                <div class="modal-body">
                                    <form class="form col-md-12" role="form" method="POST" action="{{ route('EditProductType.store') }}" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-8">
                                                <input id="modifyItemValue" name="modifyItemValue" type="text" class="form-control" value="" maxlength="4">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row ">
                                ...
                                <div class="modal-body">
                                    <form class="form col-md-12" role="form" method="POST" action="{{ route('EditProductType.store') }}" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-8">
                                                <input id="addItemValue" name="addItemValue" type="text" class="form-control" value="" maxlength="4">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row ">
