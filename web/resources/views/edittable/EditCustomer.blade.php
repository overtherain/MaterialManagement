                            ...
                            <tr>
                                ...
                                <td width="100">
                                    <div class="control-group">
                                        <div class="row">
                                            <div class="col-xs-2">
                                                <a id="modifyItemBtn" name="modifyItemBtn" type="button" class="btn btn-primary" onclick="modifyItem('{{$customer->CustomerID}}','{{$customer->CustomerName}}','{{$customer->CustomerValue}}')">修改</a>
                                            </div>
                                            <div class="col-xs-2">
                                                <form class="form col-md-12" role="form" method="POST" action="{{ route('EditCustomer.store') }}" >
                                                    {{ csrf_field() }}
                                                    <input id="deleteSubmit" name="deleteSubmit" type="text" class="form-control input-md hide" value="{{$customer->CustomerID}}" readonly>
                                ...
                                <div class="modal-body">
                                    <form class="form col-md-12" role="form" method="POST" action="{{ route('EditCustomer.store') }}" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-8">
                                                <input id="modifyItemValue" name="modifyItemValue" type="text" class="form-control" value="" maxlength="3">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row ">
                                ...
                                <div class="modal-body">
                                    <form class="form col-md-12" role="form" method="POST" action="{{ route('EditCustomer.store') }}" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-8">
                                                <input id="addItemValue" name="addItemValue" type="text" class="form-control" value="" maxlength="3">
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row ">
