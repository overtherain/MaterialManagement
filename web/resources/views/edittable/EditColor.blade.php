                            ...
                            <tr>
                                ...
                                <td width="100">
                                    <div class="control-group">
                                        <div class="row">
                                            <div class="col-xs-2">
                                                <a id="modifyItemBtn" name="modifyItemBtn" type="button" class="btn btn-primary" onclick="modifyItem('{{$color->ColorID}}','{{$color->ColorName}}','{{$color->ColorValue}}')">修改</a>
                                            </div>
                                            <div class="col-xs-2">
                                                <form class="form col-md-12" role="form" method="POST" action="{{ route('EditColor.store') }}" >
                                                    {{ csrf_field() }}
                                                    <input id="deleteSubmit" name="deleteSubmit" type="text" class="form-control input-md hide" value="{{$color->ColorID}}" readonly>
